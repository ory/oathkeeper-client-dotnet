...
namespace Ory.Oathkeeper.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.40.8";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.40.8/csharp");
        ...
        {
            string report = "C# SDK (Ory.Oathkeeper.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: v0.40.8\n";
            report += "    SDK Package Version: 0.40.8\n";
