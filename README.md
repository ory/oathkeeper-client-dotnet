# ory/oathkeeper-client-dotnet-dotnet

This is the official Ory Oathkeeper SDK for dotnet.

## Installation

Install via [.NET (nuget)](https://www.nuget.org/packages/Ory.Oathkeeper.Client/)
